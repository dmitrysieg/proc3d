define([
    ...
    var Arrows = function() {
        ...
        this.axis1 = new THREE.Vector3(0.0, 0.0, 1.0);
        this.axis2 = new THREE.Vector3(1.0, 0.0, 0.0);
        this.axis3 = new THREE.Vector3(0.0, 1.0, 0.0);
        this.position = new THREE.Vector3(0.0, 0.0, 0.0);

        this.arrow1 = new THREE.ArrowHelper(this.axis1, this.position, 1, 0xFF0000);
        this.arrow2 = new THREE.ArrowHelper(this.axis2, this.position, 1, 0xFFF000);
        this.arrow3 = new THREE.ArrowHelper(this.axis3, this.position, 1, 0xFFFF00);
