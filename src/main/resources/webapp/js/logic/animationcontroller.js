...
define([
    ...
    AnimationController.prototype = {
        ...
        animate: function() {
            ...
            var convex = this.geometryProcessor.createConvexPolygon(this.intersectingPlane, intersectionCutPoints);
            this.intersectionCut = convex.group;
            this.scene.add(this.intersectionCut);

            // todo: make less dirty
            if (this.graph) {
                //console.log(convex.area);
                this.graph.update(0.6 * convex.area);
            }
        },
